  ...
  return (
    <section className="px-6 md:px-12 py-20 bg-white border-b-[3px] border-black text-center">
      ...
      <p className="text-md md:text-lg max-w-2xl mx-auto font-medium mb-6">
        ...
        Di sini saya menulis tentang teknologi, desain web, dan rekayasa <em>perangkat lunak</em>. Saya juga memiliki keahlian di bidang <strong>software engineer</strong>, <strong>AI engineer</strong>, dan <strong>IoT engineer</strong>.
      </p>
